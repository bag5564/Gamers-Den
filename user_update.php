      ...
      <div id="wrapper">
        ...
        <main>
          <div id="main-content">
            <p>
            <?php
            echo "Updating user: " . $_POST["fname"] . " " . $_POST["lname"] . " " . $_POST["loginid"] . "...";
            ?>
            </p>
            <?php
            $sql = 'UPDATE users SET ';
            $sql = $sql . 'fname = "' . trim($_POST["fname"]) . '", lname = "' . trim($_POST["lname"]) . '", admin = "' . trim($_POST["admin"]) . '" ';
            $sql = $sql . 'WHERE loginid = "' . $_POST["loginid"] . '"';
            echo $sql;
            try {
