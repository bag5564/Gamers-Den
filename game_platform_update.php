      ...
      <div id="wrapper">
        ...
        <main>
          <div id="main-content">
            <p>
            <?php
            echo "Updating platform for game-platform: " . $_POST["gameid"] . " " . $_POST["platform_code"] . " " . $_POST["publisherid"] . " " . $_POST["release_year"];
            ?>
            </p>
            <?php
            $sql = 'UPDATE game_platforms SET ';
            $sql = $sql . 'publisherid = ' . $_POST["publisherid"] . ', release_year = ' . trim($_POST["release_year"]);
            $sql = $sql . ' WHERE gameid = ' . $_POST["gameid"] . ' AND platform_code = "' . $_POST["platform_code"] . '"';
            try {
